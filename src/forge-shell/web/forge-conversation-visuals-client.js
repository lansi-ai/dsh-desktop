/**
 * @lansi-ai/dsh-forge-conversation-visuals —— 对话区视觉层插件（子元素侧 · 不接管槽位）。
 *
...
window.__ModuleLoader__.load({
  id: '@lansi-ai/dsh-forge-conversation-visuals',
  factory: () => {
...
/* 主对话框（官方 ConversationRoot 根节点 <div class="wSkVaW_root" data-phase>）：
   ...
   .dsh-forge-layout-center 祖先，避免实际 DOM 祖先层级不确定）。
...
`
      ...
      document.querySelector('style[data-plugin="@lansi-ai/dsh-forge-conversation-visuals"]')?.remove()
      const tag = document.createElement('style')
      tag.dataset.plugin = '@lansi-ai/dsh-forge-conversation-visuals'
      tag.textContent = css
