/**
 * @lansi-ai/dsh-forge-theme —— 桌面外观设置注入（图标包选择 + 图标槽位补齐）。
 *
 ...
 *
 * 槽位真源在主进程 `ICON_SLOTS`（forge-theme.ts），本文件只渲染 host 下发的
...
`
    if (typeof document !== 'undefined' && document.querySelector('style[data-plugin="@lansi-ai/dsh-forge-theme"]') === null) {
      const tag = document.createElement('style')
      tag.dataset.plugin = '@lansi-ai/dsh-forge-theme'
      tag.textContent = css
    ...
    exports.apply = (ctx) => {
      ...
      ctx.slots.inject('settings.section', () => ctx.slots.register({
        ...
        order: 11,
        label: () => '\u5916\u89c2',
        locale: '@lansi-ai/dsh-forge-theme',
        ...
        h('div', { className: 'dsa-block dsa-section' },
          h('div', { className: 'dsa-head' },
            h('div', { className: 'dsa-heading' },
              ...
              h('div', { className: 'dsa-desc' }, '\u5305\u7ba1\u754c\u9762\u56fe\u6807\uff08\u8bbe\u7f6e\u5165\u53e3\u4e0e\u5bfc\u822a\u3001\u7a97\u63a7\u3001\u6298\u53e0\u94ae\u3001\u4fa7\u680f\u5de5\u4f5c\u533a\uff09\uff0c\u5207\u6362\u5305\u5373\u6574\u5957\u66f4\u6362\uff1b\u4e0e\u914d\u8272\u4e3b\u9898\u4e92\u4e0d\u7ea6\u675f\u3002\u5e94\u7528/\u6258\u76d8\u56fe\u6807\u4e0e\u54c1\u724c logo \u5728\u4e0a\u65b9\uff0c\u5168\u5c40\u5355\u4efd\u3001\u4e0d\u968f\u5305\u5207\u6362'),
            ),
            h('button', {
              type: 'button',
