...
| `@lansi-ai/dsh-desktop-titlebar` | `desktop-titlebar-client.js` | titlebar 行：品牌区（官方 FishLogo/BrandWordmark，坑 23）+ 折叠钮 + 中部拖拽区 + 窗控三钮 SVG（inject: slots+layout） | ✅（v3 收口 2026-08-28，实机通过） |
