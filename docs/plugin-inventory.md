...
| **P3 侧栏自研** | 侧栏壳（✅ 实机通过）+ 会话浏览区（`ui-workspace` 替换，W1-W5） | 🔄 壳 ✅；**W1 五接管面 + picker 承重件 ✅；W2 tree 派生层 ✅**（2026-09-08，图谱/冒烟/行为断言 + 派生单测通过，**待实机点验**）→ W3 Rows / W4 Browser 增强（搜索·视图选项·折叠）/ W5 实机对照点验收口 |
